...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <h2 class="m-t-0 m-b-20 header-titles"><b>Chart Report Users</b></h2>
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <div class=" col-md-3 offset-md-6">
                                    <button type="button" class="btn btn-info searchs" onclick="changeData_User()">
                                        <i class="fa fa-arrow-right" aria-hidden="true"></i> Go
                                    </button>
                                </div>
                            </div>
