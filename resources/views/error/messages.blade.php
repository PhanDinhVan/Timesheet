...
<!-- select username -->
<div id="select_username" class="modal fade" role="dialog">
    <div class="modal-dialog modal-sm">
...
<!-- enter username -->
<div id="enter_username" class="modal fade" role="dialog">
    <div class="modal-dialog modal-sm">
...
<!-- enter password -->
<div id="enter_password" class="modal fade" role="dialog">
    <div class="modal-dialog modal-sm">
